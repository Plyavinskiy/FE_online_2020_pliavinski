...
class Post {
  ...
  getReadMoreLink() {
    const link = `<a class="post__button btn-inverse" href="./post.html?id=${this.id}">Read more</a>`;
    return link;
  }
...
class TextPost extends Post {
  getHtml() {
    ...
    content.insertAdjacentHTML('beforeend', this.getPostDetails() + this.getPostHeader() + this.getPostText() + this.getReadMoreLink());
    return post;
  }
}
