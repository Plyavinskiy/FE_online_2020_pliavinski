  ...
  .then(() => {
    function myMap() {
      const mapProp = {
        ...
        center: new google.maps.LatLng(40.740974, -74.047415),
        zoom: 16,
      ...
      new google.maps.Marker({
        // eslint-disable-next-line no-undef
        position: new google.maps.LatLng(40.739879, -74.046851),
      ...
      new google.maps.Marker({
        // eslint-disable-next-line no-undef
        position: new google.maps.LatLng(40.736219, -74.049506),
        icon: 'http://maps.google.com/mapfiles/kml/paddle/H.png',
        map,
      });
    }
